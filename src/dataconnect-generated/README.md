...
// Variables can be defined inline as well.
const { data } = await createSkill({ title: ..., description: ..., tags: ..., installCommand: ..., promptConfig: ..., usageExample: ..., });
...
// Variables can be defined inline as well.
const ref = createSkillRef({ title: ..., description: ..., tags: ..., installCommand: ..., promptConfig: ..., usageExample: ..., });
